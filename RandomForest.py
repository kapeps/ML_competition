...
for j in range(cross_validation_train.shape[0]):
        #fit1
    model = RandomForestClassifier(n_estimators=750, random_state=0)
...
# save results
save("features/RF_features_train.npy",svc_results)
save("features/RF_features_test.npy",svc_results_test)
